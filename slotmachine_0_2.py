...
# Date Last Modified: Wednesday, 6 June 2013
""" 
  ...
  Version: 0.2 - * added slotmachine GUI including the background, spin button, bet button and reset button.
                    text that show the credit, bet and winner paid
"""
...
def main():
    ...
    #set up the windows
    width, height = 406, 407
    screen = pygame.display.set_mode((width, height))
    screen_color = 248,248,255
    pygame.display.set_caption("Slot Machine")
    
    #load the image for background, buttons and the reels
    background = pygame.image.load('slotMachine.gif')
    spin = pygame.image.load('spin_button.png')
    bet  = pygame.image.load('bet_button.png')
    reset = pygame.image.load('reset_button.png')
    kiwi = pygame.image.load('kiwi.jpg')
    orange = pygame.image.load('orange.jpg')
    strawberry = pygame.image.load('strawberry.jpg')
    

    #set up the text for credit, bet and winner paid
    myfont = pygame.font.SysFont("Lucida Console", 26)
    label_credit = myfont.render("1000", 1, (252,6,6))
    label_bet = myfont.render("0", 1, (252,6,6))
    label_winner = myfont.render("0", 1, (252,6,6))
    
    #while the program is running set the image at the position
    while True:
        screen.fill(screen_color)
        screen.blit(background, (0,0))
        screen.blit(label_credit, (70, 265))
        screen.blit(label_bet, (195, 265))
        screen.blit(label_winner, (290,265))
        screen.blit(spin, (300,340))
        screen.blit(bet, (200, 340))
        screen.blit(reset, (50, 340))
        screen.blit(kiwi, (44,155))
        screen.blit(orange, (155,153))
        screen.blit(strawberry, (268,153))
