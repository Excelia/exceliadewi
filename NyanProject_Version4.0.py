...
""" 
  ...
  Version 4.0 - *     the music background fixed but the start and end screen game still have problem
    """
...
#handling the game event easy level     
def gameEasy():
    ...
    #create multiple enemies sprites
    ...
    while keepGoing:
        ...
        #check collisions with nyan balloon
        if nyan.rect.colliderect(baloon.rect):
            nyan.sndGain.play()
            baloon.reset()
            scoreboard.score += 100

        #check the lives value and if nyan cat hit enemies his lives decrease
...
#handling game event medium level
def gameMedium():
    ...
    while keepGoing:
        ...
        #check collisions if hits the heart it will gain lives one point
...
#handling game event hard level
def gameHard():
